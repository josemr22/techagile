    ...
    <div class="
      ...
      <div class="
        ...
        <a class="
              ...
              uppercase
              text-white
            " href="../index.html">Tech Agile | Dashboard</a>
      </div>
      <div class="
            lg:flex
            flex-grow
            ...
            hidden
          " id="example-collapse-navbar"></div>
    </div>
  </nav>
  <main>
                ...
                <form>
                  <div class="relative w-full mb-3">
                    <label class="
                          ...
                          font-bold
                          mb-2
                        " for="grid-password">Usuario</label><input type="email" class="
                          border-0
                          px-3
                          py-3
                  ...
                  <div class="relative w-full mb-3">
                    <label class="
                          ...
                          font-bold
                          mb-2
                        " for="grid-password">Password</label><input type="password" class="
                          border-0
                          px-3
                          py-3
                          placeholder-blueGray-300
          ...
          <div class="
            ...
            <div class="w-full md:w-4/12 px-4">
              <div class="
                ...
                <a href="https://www.creative-tim.com?ref=njs-login" class="
                      text-white
